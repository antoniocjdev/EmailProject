...
public class EmailBean implements Serializable {
	...
	private static final String DESTINATARIO = "treinamentojdvmail@gmail.com";
	private static final String ASSSUNTO = "Mudança de senha";
	...
	private Email montarEmail() {
		...
		return layout.montarEmailAdministrador(DESTINATARIO, ASSSUNTO);
	}
}
